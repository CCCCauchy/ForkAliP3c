...
import com.panda.p3c.idea.util.HighlightInfoTypes
import com.panda.p3c.idea.util.HighlightSeverities
import com.panda.smartfox.idea.common.component.AliBaseApplicationComponent
...
class CommonSettingsApplicationComponent(private val p3cConfig: P3cConfig) : AliBaseApplicationComponent {
    ...
    companion object {
        val analyticsGroupId = "com.panda.p3c.analytics.action_group"
