...
* 7 ``[Recommended]`` The total number of lines for a method should not be more than 40.
Note: The total number of lines, including the method signature, closing brace, codes, comments, blank lines, line breaks and any invisible lines, should not be more than 40.
