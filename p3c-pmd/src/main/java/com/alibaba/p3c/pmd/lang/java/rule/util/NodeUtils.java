...
public class NodeUtils {
     ...
     */
    public static boolean isChild(TypeNode parentNode, @NotNull String clazzEndSuffix) {
        boolean isChild = TypeHelper.isA(parentNode, clazzEndSuffix);
        if (!isChild && parentNode.getImage() != null) {
            return clazzEndSuffix.equals(parentNode.getImage()) ||
                    parentNode.getImage().endsWith(clazzEndSuffix);
        }
        return isChild;
    }
}
